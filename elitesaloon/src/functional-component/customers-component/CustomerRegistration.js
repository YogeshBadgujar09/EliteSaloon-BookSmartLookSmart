...
const CustomerRegistration = () => {
  ...
  const validate = () => {
    ...
    if (!form.customerMobileNo || form.customerMobileNo.length < 10) {
    ...
    } else if (form.customerPassword !== form.confirmPassword) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const payload = {
        ...
        customerMobile: form.customerMobileNo,
